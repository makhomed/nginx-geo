...
It maps the visitor’s IP address to a [standard two-letter country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) or the following [special country codes](https://developers.cloudflare.com/fundamentals/reference/http-headers/#cf-ipcountry):
